...
namespace medusa
{
	...
	*/
	...
	public:
		...
		//virtual std::shared_ptr<IUniformBuffer> create_uniform_buffer(const std::string& blockName) = 0;
		virtual bool bindUniformBlock(const std::string& name, std::shared_ptr<IUniformBuffer> uniformBuffer) = 0;
		virtual bool bindBufferBlock(const std::string& name, std::shared_ptr<IStorageBuffer> storageBuffer) = 0;
