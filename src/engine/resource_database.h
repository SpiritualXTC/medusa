...
namespace medusa
{
    ...
    public:
        ...
        std::shared_ptr<Geometry> getModel(const std::string& modelName, std::shared_ptr<GenericMap<Material>> materials = nullptr, std::shared_ptr<TextureManager> textures = nullptr);
